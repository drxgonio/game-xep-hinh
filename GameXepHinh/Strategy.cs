...
namespace GameXepHinh
{
    class Strategy
    {
        ...
        internal delegate void PuzzleSolution(int steps, int stateExamined);
        ...
        internal sealed class PuzzleStrategy
        {
            ...
            //internal event EventHandler SendStateCount;
            ...
            private void Start(int[] nodes, Heuristic heuristic)
            {
                ...
                MinPriorityQueue<State> openStateQueue = new MinPriorityQueue<State>(500000);
                Dictionary<String, State> closedQueue = new Dictionary<string, State>(500000);
                ...
                while (!openStateQueue.IsEmpty() && !isStop && stateCount<=3500000)
                {
                    ...
                    if (nextStates.Count > 0)
                    {
                        ...
                        for (int i = 0; i < nextStates.Count; i++)
                        {
                            ...
                            if (!openStates.Contains(nextState.GetStateCode()))
                            {
                                ...
                                stateCode = nextState.GetStateCode();
        ...
        internal sealed class MinPriorityQueue<T> where T : IComparable
        {
            ...
            private void Expand(int capacity)
            {
                ...
                Array.Resize(ref mArray, capacity + 1);
